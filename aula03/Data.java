...
public class Data {
  ...
  public Data(String s){
    ...
    ano = Integer.parseInt(str[0]);
    if(!dataValida(dia, mes, ano)){
      System.err.println("dahvw");
      System.exit(1); 
    }
  }
  ...
  public static int diasDoMes(int mes, int ano) {
    return (mes==2 && bissexto(ano)) ? 29 : diasMesComum[mes - 1];
  }

  /** Devolve o mes da data por extenso. */
  public String mesExtenso() {
    String[] meses = {"Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezemnbro"};
    return meses[mes - 1];
  }
